 ...
 * @package panoramic
 */
define( 'PANORAMIC_THEME_VERSION' , '1.0.57' );
...
function panoramic_wpforms_shareasale_id( $shareasale_id ) {
...
add_filter( 'wpforms_shareasale_id', 'panoramic_wpforms_shareasale_id' );
